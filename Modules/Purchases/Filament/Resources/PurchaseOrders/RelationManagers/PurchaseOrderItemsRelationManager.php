...
namespace Modules\Purchases\Filament\Resources\PurchaseOrders\RelationManagers;
            ...
            ->components([
                Select::make('product_id')
                    ...
                    ->afterStateUpdated(function (callable $set, ?string $state): void {
                        ...
                        $set('unit_cost', $state ? Product::query()->find($state)?->cost_price : null);
                    }),
        ...
        return $table
            ->columns([
                ...
                TextColumn::make('total')
                    ->label('Total')
                    ->state(fn (PurchaseOrderItem $record): float => $record->total)
                    ->money('BRL'),
            ])
            ->headerActions([
                CreateAction::make()
